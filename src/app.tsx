...
export function App() {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-viagem bg-no-repeat bg-center">
      <div className="max-w-3xl w-full px-6 text-center  space-y-10">
        ...
        <p className="text-sm text-zinc-500">
          ...
          como nosso <a className="text-zinc-300 underline" href="#">termos de uso</a> e <a className="text-zinc-300 underline" href="#">politicas de privacidade</a>
        </p>
      </div>
      {isGuestModalOpen && (
